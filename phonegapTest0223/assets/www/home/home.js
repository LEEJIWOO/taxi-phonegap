							...
							.append(
									$("<a>")
										...
										.on("touchend", function() {
											...
											app.initialize(roomNo);
											console.log("=====================================================");
											console.log("roomNo :+: " + roomNo + "...................app.initialize() 호출");
											console.log("=====================================================");
										}) ) )
				.appendTo( $("#ulRoomList") );
...
var joinRoom = function(regId, roomNo) {
	...
	console.log("=================================================================");
	console.log("roomNo ::::"+ roomNo + "regId ::::" + regId);
	console.log("=================================================================");
...
//	console.log(roomInfo, idx, size);
	...
	console.log(contentWidth, contentHeight, size);
...
//		ctx1.shadowColor="black";
	...
	console.log("23222222222222222222222222222222222222222222");
//    var canvas = document.getElementById("myCanvas");
//    canvas.width = canvas.width;
//    var ctx = canvas.getContext("2d");
//
...
//    ctx.fillStyle="black";
	...
	photo.onload = function() {
		...
		ctx.drawImage(photo, 12, 7123, 75, 75);
